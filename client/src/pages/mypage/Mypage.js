    ...
    return (
        <>
            ...
            {data.data.jjimProducts === null ? (
                ...
                <ProductBasket Persondata={data.data.member} PersonMyJJimProduct={data.data.jjimProducts} />
            )}{" "}
            <PbtiBanner2 />{" "}
            {data.data.myReviews === null ? (
                <Nodata> 내 리뷰가 없어요! </Nodata>
            ) : (
                <PersonalRivew Persondata={data.data.member} PersonRivew={data.data.myReviews} />
            )}{" "}
